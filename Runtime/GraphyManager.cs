...
namespace Tayx.Graphy
{
    ...
    public class GraphyManager : G_Singleton<GraphyManager>
    {
        ...
        private G_DataRecorder m_dataRecorder = null;
        ...
        private void Update()
        {
            ...
            if(m_recoring)
            {
                m_dataRecorder.RecordFrameData();
            }
        }
        ...
        private void Init()
        {
            ...
            m_dataRecorder = new G_DataRecorder();
